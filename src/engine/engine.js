...
export const h = (node = 'div', attr = false, ...children) => {
  return { node, attr, children };
}

export const createElement = ({ node = 'div', attr = false, children }) => {
...
export const updateElement = ($parent, newNode, oldNode, index = 0) => {
  ...
  // both nodes exist but they have changed
    ...
    $parent.replaceChild(
      useTextNode ? document.createTextNode(newNode) : createElement(newNode),
